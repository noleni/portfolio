    ...
    <AboutStyle id="about" ref={ref}>
      <div className="about-content">
        ...
        <p className="presentation">
          ...
          carrière dans le secteur marketing et culturel, je me suis reconvertie
          dans l'optique de créer des outils numériques intuitifs, accessibles
          et répondants aux besoins des utilisateurs. Après un passage au sein
          du pôle User Care de Rakuten France, je développe actuellement des
          applications de data visualisation chez Daily d'initiés.
        </p>
