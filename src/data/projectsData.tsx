...
const projectsData = [
  {
    ...
    tech: [
      <TechTag
        SVG={<RubySvg height={22} width={22} />}
        name={"Ruby"}
      />,
      ...
      <TechTag
        SVG={<PostgreSvg height={22} width={22} />}
        name={"PostgreSQL"}
      />,
    ],
  ...
  },
  {
    ...
    notice:
      "J'ai codé Dream Your Meal pendant mon apprentissage de React. Il n'y a aucune base de donnée, simplement un front permettant d'ajouter des articles au panier. Le panier s'ouvre dans une modal (portal). Un contexte gère l'ensemble des données du panier.",
    date: "Septembre 2022",
    features: [],
    tech: [
      <TechTag SVG={<ReactSvg height={22} width={22} />} name={"React"} />,
      <TechTag
        SVG={<JavaScriptSvg height={22} width={22} fillcolor="#FFFF" />}
        name={"JavaScript"}
      />,
    ],
    packages: ["Devise", "Pundit", "Cloudinary", "FlatPicket", "Mapbox"],
  ...
  },
  {
    ...
    name: "Portfolio",
    notice:
      "Vous y êtes ! Mon portfolio est développé entièrement en React. J'ai utilisé styledComponents et Sass pour le design.",
    date: "Octobre 2022",
    features: [],
    tech: [
      <TechTag SVG={<ReactSvg height={22} width={22} />} name={"React"} />,
      ...
      <TechTag SVG={<SassSvg height={22} width={22} />} name={"Sass"} />,
      <TechTag
        SVG={<StyledComponentsSVG height={22} width={22} />}
